      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          {features.map((feature) => (
            <div
              key={feature.id}
              className="bg-white rounded-lg shadow-md border border-gray-200 p-6 hover:shadow-lg transition-shadow duration-300 cursor-pointer"
              onClick={() =>
                feature.link ? navigate(feature.link) : alert('Feature coming soon!')
              }
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <button className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 transition duration-300">
                    {feature.action}
                  </button>
                </div>
              </div>
